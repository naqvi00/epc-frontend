...
//         const res = await fetch(`${API_BASE}/api/institutions/public`);
//         const data = await res.json();

//         // ✅ matches your backend response: { featured, latest, archive }
...
//         title="Institutions & publishing"
//         description="A structured hub for institutional content — analysis, research papers, briefings and reports. Designed for fast scanning and deep reading on the same page."
//         crumbs={[{ label: "Home", href: "/" }, { label: "Institutions" }]}
//         actions={
//           <Link
//             to="/contact"
...
//               <div className="text-sm text-slate-600">No featured posts yet.</div>
//             )}
//           </div>
...
//             <div className="mt-3 text-sm text-slate-600">No latest posts yet.</div>
//           )}
...
//                   <div className="min-w-0">
//                     <TypePill type={p.type} />
//                     <div className="mt-2 font-heading text-base font-semibold text-slate-900">
//                       {p.title}
//                     </div>
...
//             <div className="mt-3 text-sm text-slate-600">No archive posts yet.</div>
//           )}
...
export default function Institutions() {
  const API_BASE = import.meta.env.VITE_API_BASE_URL || "http://localhost:5000";
  const PAGE = "institutions"; // ✅ backend param
  ...
  return (
    <div>
      ...
      variant="gradient"
        eyebrow="Institutions"
        title="Institutions & publishing"
        description="A structured hub for institutional content — analysis, research papers, briefings and reports."
        crumbs={[{ label: "Home", href: "/" }, { label: "Institutions" }]}
        actions={
          <Link
            to="/contact"

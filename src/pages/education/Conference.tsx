  ...
  return (
    <div>
      ...
      variant="gradient"
        eyebrow="Conference"
        title="Conference"
        description="A structured hub for Conference content — analysis, research papers, briefings and reports."
        crumbs={[{ label: "Home", href: "/" }, { label: "Conference" }]}
        actions={
          <Link
            to="/contact"

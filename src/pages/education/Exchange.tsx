      ...
      <div className="grid gap-6 p-6 md:grid-cols-12 md:items-start">
        ...
        <article className="md:col-span-7">
          ...
          <div className="mt-8 flex flex-wrap gap-3">
            ...
            >
              Request programme details <ArrowRight className="h-4 w-4" />
            </Link>
...
export default function Exchange() {
  ...
  const PAGE = "exchange"; // ✅ backend param
  ...
  return (
    <div>
      ...
      variant="gradient"
        ...
        description="Programme announcements, briefs, and reports — designed for fast scanning and deep reading on the same page."
        crumbs={[{ label: "Home", href: "/" }, { label: "Exchange programmes" }]}
        actions={
          <Link
            to="/contact"

...
const PAGE = "institutions"; // ✅ IMPORTANT
...
export default function AdminInstitutions() {
  ...
  const token = getToken(); // ✅ token-based auth
  ...
  return (
    <div>
      <div className="flex items-start justify-between gap-4">
        <div>
          <h1 className="font-heading text-2xl font-bold text-brand-ink">Institutions Page Content</h1>

...
function InitialsAvatar({ name }: { name: string }) {
  ...
  return (
    <div className="grid h-28 w-28 place-items-center rounded-full bg-gradient-to-br from-brand-navy to-brand-blue text-white shadow-card">
      <span className="font-heading text-2xl font-semibold tracking-wide">{initials}</span>
    </div>
  )
}
...
function PersonCard({ person }: { person: Person }) {
  ...
  // Show button only if there is something to expand
  const hasBio = (person.short?.trim()?.length ?? 0) > 0 || (person.long?.trim()?.length ?? 0) > 0
  ...
  return (
    <div className="group rounded-3xl border border-brand-line bg-white p-6 shadow-card transition hover:-translate-y-0.5 hover:shadow-lg">
        ...
        <div className="shrink-0">
          {person.image ? (
            <img
              src={person.image}
              alt={person.name}
              className="h-28 w-28 rounded-full border border-brand-line object-cover shadow-sm"
              loading="lazy"
            />
          ) : (
      ...
      {/* Bio: NOTHING shown initially. On Read more => show BOTH paragraphs */}
      <div className="mt-5 text-sm leading-6 text-slate-700">
        ...
        >
          {/* Paragraph 1 */}
          {person.short?.trim()?.length ? <p className="text-slate-700">{person.short}</p> : null}

          {/* Paragraph 2 */}
          {person.long?.trim()?.length ? <p className="mt-3 text-slate-700">{person.long}</p> : null}
        </div>
...
export default function Governance() {
  ...
  const advisory: Person[] = [
    ...
    },
    {
      ...
      short:
        'Environmental systems strategist and postdoctoral researcher specialising in sustainable infrastructure, water governance and circular economy innovation.',
      long: clampWords(
    ...
    },
    {
      ...
      short:
        'Pro Vice-Chancellor (STEM) and Dean with over 30 years of experience in engineering, digital technologies and higher education leadership.',
      long: clampWords(
    ...
    },
    {
      ...
      title: "Advisory Council",
      location: "United Kingdom",
      short: "International media and communications expert with senior public-sector experience and extensive international advisory work.",
      long: clampWords(
      ...
      tags: ["Media & Communications", "Public Policy", "Media Training", "Strategic Communications", "Information Integrity"],
    },
    {
      ...
      title: "Advisory Council",
      location: "United Kingdom",
      short: "British author, poet, and Old Catholic priest bridging culture, education, and philosophic dialogue across Eurasia.",
      long: clampWords(
      ...
      tags: ["Culture & Education", "Eurasia Networks", "Creative Exchange", "Philosophic Dialogue", "Regional Connectivity"],
    },
    {
    ...
    },
    {
      ...
      short: 'Senior education leader and policy contributor specialising in Central Asia, sustainability, and cross-sector cooperation.',
      long: clampWords(
  ...
  const experts: Person[] = [
    ...
    },
    {
      ...
      title: 'Expert',
      location: 'India',
      short: 'Expert on Eurasian geopolitics, Central Asia and connectivity, with a strong focus on energy security.',
      long: clampWords(
    ...
    },
    {
      ...
      short: 'International metals trader and mining investment specialist connecting Asia–Africa markets in gold, copper, and strategic resources.',
      long: clampWords(
      ...
      tags: ['Metals Trading', 'Mining Investment', 'Gold', 'Copper', 'Resource Security', 'Geopolitics', 'Asia–Africa Markets'],
    },
    {
      ...
      short: 'International cultural strategist and adviser with 20+ years in cultural diplomacy and cross-regional cooperation.',
      long: clampWords(
    ...
    },
    {
      ...
      title: 'Expert',
      location: 'China',
      short: 'Senior research fellow and cultural policy strategist with leadership in media reform and international cultural exchange.',
      long: clampWords(

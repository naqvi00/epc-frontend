...
export default function SecurityDiplomacy() {
  ...
  const page = "security-diplomacy"; // ✅ this is the only thing you change for new pages
  ...
  return (
    <div>
      ...
      variant="gradient"
        ...
        crumbs={[{ label: "Home", href: "/" }, { label: "Security & diplomacy" }]}
        actions={
          <Link
            to="/contact"
